        ...
        <Box bg='gray.200' w='100%' h='100%' >
          ...
          <FormControl padding='30px' >
            ...
            <FormLabel paddingTop='10px' color='blue.700'>Date of race</FormLabel>
              ...
              />
              <Button onClick={onSubmitForm} width='120px' variant='solid' border='2px' borderColor='blue.700' colorScheme='blue' _hover={{ bg: '#4da6ff' }} >Save</Button>
          </FormControl>
          <Stack padding='30px' align='left' >
           <Link to={"/menu"}>
              <Button width='120px' variant='solid' border='2px' borderColor='blue.700' colorScheme='blue' _hover={{ bg: '#4da6ff' }} >Back to years</Button>
           </Link>
           <Link to={"/"}>
              <Button width='120px' variant='solid' border='2px' borderColor='blue.700' colorScheme='blue' _hover={{ bg: '#4da6ff' }} >Back to home</Button>
           </Link>
          </Stack>
        </Box>
        </Container>
